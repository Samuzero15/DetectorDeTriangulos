...
public class PanelPrincipal extends javax.swing.JFrame {
        ...
        switch(accion)
        {
            ...
            case LINK2:
                ...
                if(v2 != null){
                 ...
                 lienzo1.figura.añadeArista(v1.getTag(), v2.getTag(), String.valueOf(cuentaAri));
                 cuentaAri++;
            ...
            case UNLINK1:
                ...
                if(a1 != null){
                 ...
                 msg = "Arista " + a1.getNum() + " seleccionada, click otra vez para eliminar.";
                 accion = UNLINK2;
                }
            ...
            case UNLINK2:
                ...
                if(a2 != null && a1.equals(a2)){
                 lienzo1.figura.eliminaArista(a1.getNum());
                 msg = "Arista " + a1.getNum() + " eliminado satisfactoriamente.";
                 accion = 0;
                }
                else msg = "Aqui no hay una arista.";
                break;
    ...
    private void salvaPosicion(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_salvaPosicion
        ...
        {
            Vertice i = aMueve.getvInicial();
            Vertice f = aMueve.getvFinal();
    ...
    private void mueveVertice(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mueveVertice
        ...
        if(vMueve != null){
          ...
          lienzo1.seleccionarA(vMueve);
            ...
            aMueve.mueve(dx, dy);
            lienzo1.figura.actualizarArista(aMueve.getNum(), aMueve);
    ...
    private void calculaTriangulos(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calculaTriangulos
        log.setText("Hay " + lienzo1.figura.cuantosTriangulosHay() + " en la figura!");
